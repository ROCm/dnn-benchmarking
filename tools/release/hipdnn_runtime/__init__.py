...
# Both values are substituted at wheel build time by
# tools/build_release_wheels.py.
#: GPU architecture this payload was compiled for.
__gpu_arch__ = "@GPU_ARCH@"
#: rocm-libraries commit this payload was compiled from.
__rocm_libraries_commit__ = "@ROCM_LIBRARIES_COMMIT@"
